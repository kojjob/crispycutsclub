...
export default function HomePage() {
  return (
    <>
      {/* Large Centered Logo */}
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 lg:pt-48 lg:pb-32 text-center bg-crispy-black overflow-hidden">
          {/* Premium gradient background */}
          <div className="absolute inset-0 bg-gradient-to-b from-crispy-black via-crispy-black/95 to-crispy-charcoal/20"></div>
          ...
          <div className="relative max-w-5xl mx-auto px-4">
            <div className="mb-12 md:mb-16 lg:mb-20">
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-serif font-bold text-crispy-white mb-2 animate-fade-in tracking-tight">
                Crispy Cuts
              </h1>
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl font-light text-crispy-white mb-3 md:mb-4 animate-slide-up tracking-wide">
                Join the Ultimate
              </h2>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-crispy-white animate-slide-up-delay">
                Grooming Club
              </h2>
            </div>
          </div>
        ...
        <section className="relative py-16 md:py-20 lg:py-24 bg-gradient-to-b from-crispy-charcoal/20 to-crispy-black">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              ...
              <div className="group relative">
                ...
                <div className="relative text-center p-6 md:p-8 border border-crispy-white/10 hover:border-crispy-gold/30 transition-all duration-500">
                  {/* Icon */}
                  ...
                  <h3 className="text-xl md:text-2xl font-serif font-light text-crispy-white mb-4 md:mb-6 tracking-wide">
                    Clients
                  </h3>
                  <p className="text-sm md:text-base text-crispy-white/70 mb-8 md:mb-10 leading-relaxed font-light">
                  ...
                  >
                    <span className="relative z-10 block bg-crispy-white text-crispy-black px-6 md:px-10 py-2.5 md:py-3 font-light tracking-wider uppercase text-xs md:text-sm transition-colors duration-300 group-hover/btn:text-crispy-white">
                      Learn More
                    </span>

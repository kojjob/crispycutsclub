      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-12">
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Total Cuts</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Average Rating</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Monthly Price</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Link href="/dashboard/barber/appointments" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Appointments</h3>
              <p className="text-crispy-white/60 text-sm">View and manage upcoming appointments</p>
            </div>
          </Link>
          ...
          <Link href="/dashboard/barber/availability" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Availability</h3>
              <p className="text-crispy-white/60 text-sm">Set your working hours and days off</p>
            </div>
          </Link>
          ...
          <Link href="/dashboard/barber/profile" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Profile</h3>
              <p className="text-crispy-white/60 text-sm">Update your info and portfolio</p>
            </div>
          </Link>
        </div>

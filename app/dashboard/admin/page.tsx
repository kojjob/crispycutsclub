      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6 mb-12">
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Total Users</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Clients</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Barbers</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Agencies</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Active Members</p>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <Link href="/dashboard/admin/users" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Users</h3>
              <p className="text-crispy-white/60 text-sm">Manage all users</p>
            </div>
          </Link>
          ...
          <Link href="/dashboard/admin/verifications" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Verifications</h3>
              <p className="text-crispy-white/60 text-sm">Approve barbers & agencies</p>
            </div>
          </Link>
          ...
          <Link href="/dashboard/admin/areas" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Areas</h3>
              <p className="text-crispy-white/60 text-sm">Manage service areas</p>
            </div>
          </Link>
          ...
          <Link href="/dashboard/admin/finances" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Finances</h3>
              <p className="text-crispy-white/60 text-sm">Revenue & payments</p>
            </div>
          </Link>
        </div>

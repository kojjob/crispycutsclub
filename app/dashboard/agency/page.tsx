    ...
    <div className="min-h-screen bg-crispy-black">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-12">
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            <div className="text-3xl font-bold text-crispy-gold mb-2">
              {agency?.numberOfModels || 0}
            </div>
            <p className="text-crispy-white/60 text-sm">Total Models</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Active Models</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">Total Bookings</p>
          </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6">
            ...
            <p className="text-crispy-white/60 text-sm">This Month</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Link href="/dashboard/agency/models" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Models</h3>
              <p className="text-crispy-white/60 text-sm">Manage your model roster</p>
            </div>
          </Link>
          ...
          <Link href="/dashboard/agency/bookings" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Bookings</h3>
              <p className="text-crispy-white/60 text-sm">Schedule grooming sessions</p>
            </div>
          </Link>
          ...
          <Link href="/dashboard/agency/reports" className="group">
            <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-6 hover:border-crispy-gold/30 transition-all">
              ...
              <h3 className="text-xl font-semibold text-crispy-white mb-2">Reports</h3>
              <p className="text-crispy-white/60 text-sm">View usage and billing reports</p>
            </div>
          </Link>
        </div>
          ...
          <div className="bg-crispy-charcoal/50 border border-crispy-white/10 p-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-crispy-white">{agency?.companyName || 'Not set'}</p>
              </div>
              <div>
                <p className="text-crispy-white/60 text-sm mb-1">Website</p>
                <p className="text-crispy-white">{agency?.companyWebsite || 'Not set'}</p>
              </div>
              <div>
                <p className="text-crispy-white/60 text-sm mb-1">Contact Person</p>
                <p className="text-crispy-white">{user.name} ({agency?.contactRole || 'Contact'})</p>
              </div>
            </div>
          </div>

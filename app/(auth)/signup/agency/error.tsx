...
export default function AgencySignupError({
  error,
  reset,
}: {
      ...
      <div className="max-w-md w-full space-y-8 text-center">
        <div>
          ...
          <p className="mt-2 text-crispy-gray">
            We couldn't process your agency registration.
          </p>
        </div>
        
        <div className="bg-crispy-charcoal rounded-lg p-6">
          <p className="text-sm text-crispy-error mb-4">
            {error.message || 'Failed to register agency account. Please ensure you meet the minimum requirements.'}
          </p>

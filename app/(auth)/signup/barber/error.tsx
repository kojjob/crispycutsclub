...
export default function BarberSignupError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen bg-crispy-black flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8 text-center">
        <div>
          <h1 className="text-3xl font-bold text-crispy-white">Application Failed</h1>
          <p className="mt-2 text-crispy-gray">
            We couldn't process your barber application.
          </p>
        </div>
        
        <div className="bg-crispy-charcoal rounded-lg p-6">
          <p className="text-sm text-crispy-error mb-4">
            {error.message || 'Failed to submit barber application. Please verify your information and try again.'}
          </p>
